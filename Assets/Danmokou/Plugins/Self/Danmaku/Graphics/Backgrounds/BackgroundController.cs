...
public class BackgroundController : CoroutineRegularUpdater {
    ...
    private readonly List<ShatterFragment> fragments = new List<ShatterFragment>();
    ...
    private static void Tile4(List<ShatterFragment> fragments, float fragmentRadius,
        Func<Vector2, float, ShatterFragment> fragConstr) {
