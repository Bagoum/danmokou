...
namespace DMK.DMath {
public abstract class MultiOp<T> {
    ...
    public Token CreateModifier(T m, Priority p = Priority.CLEAR_PHASE) {
...
public class MultiAdder : MultiOp<int> {
    ...
    public Token CreateToken1() => CreateModifier(1);
}
