...
public static partial class BPYRepo {
    ...
    public static ExBPY Pivot(ExBPY pivotVar, ExBPY pivot, ExBPY f1, ExBPY f2) => 
        DMKExMHelpers.Pivot<TExPI, float>(pivot, f1, f2, pivotVar);
...
*/
    ...
    public static ExBPY SoftmaxShift(string pivotVar, ExBPY sharpness, ExBPY pivot, ExBPY f1, ExBPY f2) =>
        DMKExMHelpers.SoftmaxShift<TExPI>(sharpness, pivot, f1, f2, pivotVar);
    [Alias("smsht")]
    ...
    public static ExBPY LogsumShift(string pivotVar, ExBPY sharpness, ExBPY pivot, ExBPY f1, ExBPY f2) =>
        DMKExMHelpers.LogSumShift<TExPI>(sharpness, pivot, f1, f2, pivotVar);
    ...
    /// </summary>
    public static ExBPY StarRot1() => bpi => ExMOperators.Mul(T()(bpi), BRand(_ => 60f, _ => 90f)(bpi));
    /// <summary>
    /// Default randomized star rotation (slow) in two directions.
    /// </summary>
    public static ExBPY StarRotB1() => bpi => ExMOperators.Mul(BRandpm1()(bpi), StarRot1()(bpi));
    /// <summary>
    /// Default randomized star rotation (medium) in one direction.
    /// </summary>
    public static ExBPY StarRot2() => bpi => ExMOperators.Mul(T()(bpi), BRand(_ => 100f, _ => 140f)(bpi));
    /// <summary>
    /// Default randomized star rotation (medium) in two directions.
    /// </summary>
    public static ExBPY StarRotB2() => bpi => ExMOperators.Mul(BRandpm1()(bpi), StarRot2()(bpi));
    /// <summary>
    /// Default randomized star rotation (fast) in one direction.
    /// </summary>
    public static ExBPY StarRot3() => bpi => ExMOperators.Mul(T()(bpi), BRand(_ => 160f, _ => 200f)(bpi));
    /// <summary>
    /// Default randomized star rotation (fast) in two directions.
    /// </summary>
    public static ExBPY StarRotB3() => bpi => ExMOperators.Mul(BRandpm1()(bpi), StarRot3()(bpi));
    /// <summary>
    /// Default randomized star rotation (very fast) in one direction.
    /// </summary>
    public static ExBPY StarRot4() => bpi => ExMOperators.Mul(T()(bpi), BRand(_ => 240f, _ => 300f)(bpi));
    /// <summary>
    /// Default randomized star rotation (very fast) in two directions.
    /// </summary>
    public static ExBPY StarRotB4() => bpi => ExMOperators.Mul(BRandpm1()(bpi), StarRot4()(bpi));
