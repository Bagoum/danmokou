...
public static class ExMEasers {
    //Signatures are tfloat => tfloat even when TEx.Resolve is required, in order to enable LookupMethod.
    ...
    public static tfloat EInQuad(tfloat x) => TEx.ResolveF(x, y => y.Mul(y));
    public static tfloat EOutQuad(tfloat x) => TEx.ResolveF(E1.Sub(x), y => E1.Sub(y.Mul(y)));
    public static tfloat EIOQuad(tfloat x) => TEx.ResolveF(E2.Mul(x), y =>
    ...
    public static tfloat EInQuart(tfloat x) => TEx.ResolveF(x, y => y.Mul(y).Mul(y).Mul(y));
    public static tfloat EOutQuart(tfloat x) => TEx.ResolveF(E1.Sub(x), y => E1.Sub(y.Mul(y).Mul(y).Mul(y)));
    public static tfloat EIOQuart(tfloat x) => TEx.ResolveF(E2.Mul(x), y =>
        Ex.Condition(y.LT(E1),
    ...
    public static tfloat EInElastic(tfloat x) => TEx.ResolveF(x, y => 
        Pow(E2, y.Mul(10).Sub(10)).Mul(Sin(y.Sub(1.075f).Mul(pi).Div(-0.15f))));
    public static tfloat EOutElastic(tfloat x) => TEx.ResolveF(x, y => 
        Pow(E2, y.Mul(-10)).Mul(Sin(y.Sub(.075f).Mul(pi).Div(0.15f))).Add(E1));
    public static tfloat EIOElastic(tfloat x) => TEx.ResolveF(x, y => 
    ...
    public static tfloat EOutBounce(tfloat x) => TEx.ResolveF(x, y => 
    ...
    public static tfloat EIOBounce(tfloat x) => TEx.ResolveF(x, y => 
        Ex.Condition(y.LT(E05),
    ...
    public static tfloat EBounce2(tfloat x) => TEx.Resolve<float>((Ex)x, c => {
        var c1 = VFloat();
        var c2 = VFloat();
    ...
    public static tfloat CEInBack(tfloat p1, tfloat x) => TEx.Resolve(p1, x, (p, y) => y.Mul(y).Mul(
        E1.Add(p).Mul(y).Sub(p)
    ));
    public static tfloat CEOutBack(tfloat p1, tfloat x) => TEx.Resolve<float, float>(p1, x.Sub(E1), (p, y) => y.Mul(y).Mul(
        E1.Add(p).Mul(y).Add(p)
    ).Add(E1));
    public static tfloat CEIOBack(tfloat p1, tfloat x) => TEx.Resolve<float, float>(p1, E2.Mul(x), (p, y) =>
        Ex.Condition(y.LT(E1),
