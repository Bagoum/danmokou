...
public class Chimata : SZYUCharacter {
    ...
    public override LString Name { get; set; } = LocalizedStrings.FindReference("dialogue.chimata");

    public override void RollEvent() => ISFXService.SFXService.Request("x-bubble-3", SFXType.TypingSound);
}

public class ChimataMimic : PiecewiseCharacterMimic {
    public override Type[] CoreTypes => new[] {typeof(Chimata)};
}
