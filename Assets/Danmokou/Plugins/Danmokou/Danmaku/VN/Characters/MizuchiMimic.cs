...
public class Mizuchi : SZYUCharacter {
    ...
    public override LString Name { get; set; } = LocalizedStrings.FindReference("dialogue.mizuchi");

    public override void RollEvent() => ISFXService.SFXService.Request("x-bubble-2", SFXType.TypingSound);
}

public class MizuchiMimic : PiecewiseCharacterMimic {
    public override Type[] CoreTypes => new[] {typeof(Mizuchi)};
}
