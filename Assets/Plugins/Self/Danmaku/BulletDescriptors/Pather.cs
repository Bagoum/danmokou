...
public class Pather : Bullet {
    ...
    private void Initialize(bool isNew, Velocity velocity, SOCircle _target, int firingIndex, uint bpiid, float maxRemember,
        ...
        ctr.Initialize(this, material, isNew, velocity, bpiid, firingIndex, remember, maxRemember, _target, ref options);
    ...
    public static void Request(FrameAnimBullet.Recolor recolor, Velocity velocity, int firingIndex, uint bpiid, float maxRemember, DMath.BPY remember, SOCircle collisionTarget, ref RealizedBehOptions opts) {
