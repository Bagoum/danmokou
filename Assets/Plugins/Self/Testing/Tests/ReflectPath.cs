...
namespace Tests {
    ...
    public static class ReflectPath {
        ...
        public static void TPolar() {
            ...
            Velocity v = new Velocity(pivoter, Vector2.right, V2RV2.Angle(25), MovementModifiers.Default);
            Velocity v2 = new Velocity(pivoter2, Vector2.right, V2RV2.Angle(25), MovementModifiers.Default);
            ...
            v = new Velocity(pivoter, Vector2.left, V2RV2.NRotAngled(1, 1, 25), MovementModifiers.Default);
            v2 = new Velocity(pivoter2, Vector2.left, V2RV2.NRotAngled(1, 1, 25), MovementModifiers.Default);
            v.UpdateDeltaAssignAcc(ref bpi, out var _, 1f);
            v2.UpdateDeltaAssignAcc(ref bpi2, out var _, 1f);
        ...
        public static void TCartesian() {
            ...
            Velocity v = new Velocity(pivoter, Vector2.zero, V2RV2.Angle(25), MovementModifiers.Default);
            v.UpdateDeltaAssignAcc(ref bpi, out var _, 1f);
            ...
            v = new Velocity(pivoter, Vector2.zero, V2RV2.Angle(25), MovementModifiers.Default);
            ...
            bpi = new ParametricInfo(Vector2.down, 3, 0, 0f);
            v = new Velocity(pivoter, Vector2.zero, V2RV2.Angle(25), MovementModifiers.WithXFlip);
            v.UpdateDeltaAssignAcc(ref bpi, out var _, 2f);
        ...
        public static void TCartesianRotNRot() {
            ...
            var bpi = new ParametricInfo(Vector2.down, 3, 0, 0f);
            Velocity v = new Velocity(p, Vector2.zero, V2RV2.Angle(25), MovementModifiers.Default);
            v.UpdateDeltaAssignAcc(ref bpi, out var _, 1f);
            ...
            bpi = new ParametricInfo(Vector2.down, 3, 0, 0f);
            v = new Velocity(p, Vector2.zero, V2RV2.Angle(25), MovementModifiers.Default);
            v.UpdateDeltaAssignAcc(ref bpi, out var _, 1f);
