...
**Warning:** This tutorial is incredibly difficult and you may need to skip it for now. At the least, read to the part about GCRule, as there are a few important points at the beginning.
