...
First, we use the `preloop` command to set a variable `loop` to the iteration number (0 or 1, since there are two iterations) of the gtrepeat. We could give it any other name.
