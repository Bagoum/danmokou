...
In this tutorial, we're going to go through almost all of the repeater modifiers in the engine. Use this page as a reference!
...
These three modifiers allow pausing or stopping the loop based on arbitrary conditions.
...
`SFX` and all its siblings simply create sound effects when used. They take an array of sound effects and loop through them.
