...
You can view all bullet controls here: <xref:Danmaku.BulletManager.SimpleBulletControls>, or in Danmaku/BulletManagement/BulletControls.cs:SimpleBulletControls.
