...
Note that it is not required to use Suzunoya for visual novel support in Danmokou. You can hook up any visual novel engine you like and call it from BDSL scripts by adding an engine method similar to [ExecuteVN](https://github.com/Bagoum/danmokou/blob/9386de513b70b5f08bcc1c2815fc52996a19680a/Assets/Danmokou/Plugins/Danmokou/Danmaku/StateMachines/ReflectedSM/ReflectedSM.cs#L316), which is the engine method used for calling Suzunoya from BDSL. However, Danmokou provides a baseline implementation of Suzunoya's engine requirements, and Suzunoya provides a baseline implementation of common dialogue system requirements, making them convenient to use together.
